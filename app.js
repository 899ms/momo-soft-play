...
$('#download').onclick=()=>{if(!cardURL)return;const a=document.createElement('a');a.href=cardURL;a.download='MOMO-'+today()+'.jpg';a.click();$('#share-status').textContent='收藏卡已准备下载，手机也可以长按图片保存';};
